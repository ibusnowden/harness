...
var builtinSpecs = []Spec{
	...
	{Name: "review", Summary: "Inspect code for bugs, regressions, and missing tests", Usage: "/review [scope]", SourceHint: "built-in", Responsibility: "Run the code review workflow", ResumeSupported: false},
	...
	{Name: "security-review", Summary: "Inspect the codebase for security issues", Usage: "/security-review [scope]", SourceHint: "built-in", Responsibility: "Run the security review workflow", ResumeSupported: false},
	{Name: "bughunter", Summary: "Inspect the codebase for likely bugs", Usage: "/bughunter [scope]", SourceHint: "built-in", Responsibility: "Run the bughunter workflow", ResumeSupported: false},

#!/usr/bin/env bash
# connect-rtx.sh - create an SSH tunnel from localhost to the running RTX vLLM server.
...
#
# Usage: ./inference/connect-rtx.sh <model-alias>
# Example: ./inference/connect-rtx.sh qwen3.6-30b-a3b
set -euo pipefail
